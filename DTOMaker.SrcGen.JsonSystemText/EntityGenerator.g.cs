            ...
            switch (member.Kind)
            {
                case MemberKind.Struct:
                    if (member.IsNullable)
                    {
                        ...
                        else
                        {
                            ...
                            Emit("        [JsonPropertyName(\"T_NullableNativeStructMemberJsonName_\")]");
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            Emit("        [JsonPropertyName(\"T_RequiredNativeStructMemberJsonName_\")]");
                ...
                case MemberKind.Entity:
                    if (member.IsNullable)
                    {
                        ...
                        Emit("        [JsonPropertyName(\"T_NullableEntityMemberJsonName_\")]");
                    ...
                    else
                    {
                        ...
                        Emit("        [JsonPropertyName(\"T_RequiredEntityMemberJsonName_\")]");
                ...
                case MemberKind.Binary:
                    if (member.IsNullable)
                    {
                        Emit("        [JsonPropertyName(\"T_NullableBinaryMemberJsonName_\")]");
                        Emit("        [JsonInclude]");
                    ...
                    {
                        Emit("        [JsonPropertyName(\"T_RequiredBinaryMemberJsonName_\")]");
                        Emit("        [JsonInclude]");
                ...
                case MemberKind.String:
                    if (member.IsNullable)
                    {
                        ...
                        Emit("        [JsonPropertyName(\"T_NullableStringMemberJsonName_\")]");
                    ...
                    else
                    {
                        ...
                        Emit("        [JsonPropertyName(\"T_RequiredStringMemberJsonName_\")]");
